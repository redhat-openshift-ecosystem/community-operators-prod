...
COPY bundle/1.1.1-v2.5.9.final/manifests /manifests/
COPY bundle/1.1.1-v2.5.9.final/metadata /metadata/
COPY bundle/1.1.1-v2.5.9.final/tests/scorecard /tests/scorecard/
